export const SITE_URL = 'https://pocho.tech';
export const SITE_NAME = 'pocho.tech';
export const CALENDLY = 'https://calendly.com/erick-pocho/1hr-session';
export const EMAIL = 'erick.bonilla63@gmail.com';
export const FOUNDER = 'Erick Bonilla';
